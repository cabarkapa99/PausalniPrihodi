...
const legalPagesSeed = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "10. Pro pretplata, plaćanje i refundacija",
      'Uslugu Paušalni Prihodi pruža UWIT DOO. Naplatu Pro pretplate obrađuje Paddle.com ("Paddle") kao ovlašćeni prodavac (Merchant of Record) — Paddle izdaje račun za kupovinu i njegov naziv se pojavljuje na izvodu vaše platne kartice.',
      "Pro plan se plaća platnom karticom: 3 € mesečno ili 29 € godišnje. Pretplata se automatski obnavlja na kraju svakog obračunskog perioda dok je ne otkažete.",
      "Pretplatu možete otkazati u bilo kom trenutku u aplikaciji (Profil → Pretplata). Otkazivanje stupa na snagu na kraju tekućeg plaćenog perioda — do tada zadržavate sve Pro funkcije.",
      "Uslovi povraćaja novca opisani su u Politici refundacije, dostupnoj na pausalni-prihodi.com/refund.",
      "11. Primena zakona",
  ...
  },
  {
    ...
    paragraphs: [
      "Poslednja izmena: 14. 9. 2026.",
      "1. Ko obrađuje plaćanja",
      'Pro pretplatu za Paušalni Prihodi (uslugu pruža UWIT DOO) naplaćuje Paddle.com ("Paddle") kao ovlašćeni prodavac (Merchant of Record). Paddle izdaje račun za kupovinu i njegov naziv se pojavljuje na izvodu vaše platne kartice.',
      "2. Otkazivanje pretplate",
      "Pretplatu možete otkazati u bilo kom trenutku, jednim klikom, u aplikaciji: Profil → Pretplata → Pređi na Starter. Otkazivanje stupa na snagu na kraju tekućeg plaćenog perioda — do tada zadržavate pun pristup Pro funkcijama i novih naplata neće biti. Zakazano otkazivanje možete poništiti opcijom „Zadrži Pro“ pre isteka perioda.",
      "3. Garancija povraćaja novca — rok od 30 dana",
      "Rok za povraćaj novca za prvu uplatu iznosi tačno 30 (trideset) kalendarskih dana od datuma prve uplate (mesečne ili godišnje). U tom roku možete zatražiti povraćaj celokupnog iznosa — bez dodatnih pitanja.",
      "4. Naplate obnove pretplate — rok od 14 dana",
      "Rok za povraćaj novca za naplate obnove (mesečne ili godišnje) iznosi tačno 14 (četrnaest) kalendarskih dana od datuma naplate obnove.",
      "5. Kako zatražiti povraćaj",
      "Pišite nam na podrska@pausalni-prihodi.com sa email adresom naloga i datumom uplate. Povraćaj obrađuje Paddle na isti način plaćanja kojim je izvršena uplata, obično u roku od 5 do 10 radnih dana.",
      "6. Besplatan (Starter) plan",
      "Starter plan je besplatan i ne podleže naplati ni refundaciji. Nakon otkazivanja Pro pretplate vaš nalog i svi podaci ostaju sačuvani na Starter planu.",
      "7. Kontakt",
      "Email: podrska@pausalni-prihodi.com",
      "Telefon: +381 62 145 5633",
      "— English version —",
      "Refund & Cancellation Policy",
      "Payments for the Paušalni Prihodi Pro subscription (a service provided by UWIT DOO) are processed by Paddle.com as Merchant of Record — Paddle issues the invoice and appears on your card statement.",
      "Cancellation: you can cancel at any time, in one click, in the app (Profile → Subscription → Switch to Starter). Cancellation takes effect at the end of the current paid billing period; you keep full Pro access until then and will not be charged again.",
      "Refund window — first purchase: 30 (thirty) calendar days from the date of the first charge (monthly or yearly). Within this window you can request a full refund, no questions asked.",
      "Refund window — renewal charges: 14 (fourteen) calendar days from the date of the renewal charge (monthly or yearly).",
      "How to request a refund: email podrska@pausalni-prihodi.com with your account email address and the payment date. Refunds are processed by Paddle to the original payment method, typically within 5–10 business days.",
      "The Starter plan is free of charge and involves no payments or refunds. After cancelling Pro, your account and all data remain available on the Starter plan.",
    ],
  },
  {
    slug: "cookies",
  ...
  pricing: {
    ...
    plans: [
      ...
      },
      {
        ...
        price: "3 €",
        period: "/mesečno",
        ctaText: "Pređi na Pro",
        ctaUrl: `${APP_URL}/register`,
        features: [
          { value: "Sve iz besplatnog plana" },
          { value: "Ponavljajuće (automatske) fakture" },
          { value: "SEF XML izvoz" },
          { value: "B2B API za integracije" },
          { value: "PDF fakture bez watermarka" },
          { value: "Godišnje: 29 € (2 meseca gratis)" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        answer:
          "Da! Besplatan plan uključuje neograničen broj faktura, praćenje limita od 6M RSD, domaće i inostrane fakture i upravljanje klijentima. Pro plan — 3 € mesečno ili 29 € godišnje (2 meseca gratis), plaćanje karticom — dodaje ponavljajuće fakture, SEF XML izvoz, B2B API i PDF fakture bez watermarka.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Naravno. Nema ugovora, nema skrivenih troškova. Otkazujete jednim klikom u aplikaciji — Pro ostaje aktivan do kraja plaćenog perioda, a zatim se nalog vraća na besplatan plan. Svi vaši podaci ostaju sačuvani. Detalji o povraćaju novca su u našoj Politici refundacije.",
      },
      {
        question: "Da li generišete eFakture za SEF?",
        answer:
          "Da — na Pro planu možete izvesti fakturu kao SEF-kompatibilan XML (UBL) i uvesti je u Sistem eFaktura. Direktno slanje na SEF putem API-ja je u planu.",
      },
    ],
  },
  "final-cta": {
