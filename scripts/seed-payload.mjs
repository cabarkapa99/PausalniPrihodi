...
const legalPagesSeed = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "3. Garancija povraćaja novca (30 dana)",
      "Ako niste zadovoljni uslugom, možete zatražiti povraćaj celokupnog iznosa prve uplate (mesečne ili godišnje) u roku od 30 dana od datuma te uplate — bez dodatnih pitanja.",
      "4. Naplate obnove pretplate",
      "Za naplate obnove (mesečne ili godišnje) povraćaj možete zatražiti u roku od 14 dana od datuma naplate. Zahteve razmatramo razumno i dobronamerno.",
