      ...
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Kontaktirajte <span className="text-blue-600">nas</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Imate pitanja ili trebate pomoć? Naš tim je tu da vam pomogne.
            Kontaktirajte nas putem forme ili direktno putem email-a.
          </p>
        </motion.div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">pausalni-prihodi@uwit.rs</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Vikend: Ne radimo</p>
                  </div>
                </div>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className={`w-full font-bold py-4 px-6 rounded-lg text-lg transition duration-300 transform ${
                  isSubmitting
